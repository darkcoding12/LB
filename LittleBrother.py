...
mainOption = """
 ...
 [e] Выход    [h] Подсказка    [c] Очистить экран"""


lookupOption = """
 [1] Personne lookup          [8] Mail tracer
 [2] Пробив по нику           [9] Employés recherche
 [3] Adresse lookup           [10] Google поиск
 [4] Пробив номера            [11] Facebook пробив
 [5] Пробив IP                [12] twitter пробив
 [6] Пробив по MAC/BSSID      [13] instagram пробив
 [7] Email пробив

 [b] В главное меню    [e] Выход    [h] Подсказка    [c] Очистить экран"""
